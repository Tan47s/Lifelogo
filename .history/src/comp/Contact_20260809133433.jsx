...
const contactItems = [
  {
    ...
    label: 'Our Location',
    value: '14 Serenity Close, Westland District\nAccra, Ghana',
    link: null,
  },
  {
    icon: (
    ...
    label: 'Phone',
    value: '+233 30 298 1100\n+233 24 456 7890',
    link: 'tel:+233302981100',
  },
  {
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    ...
    label: 'Email',
    value: 'hello@lifelogo.org',
    link: 'mailto:hello@lifelogo.org',
  },
  {
    icon: (
