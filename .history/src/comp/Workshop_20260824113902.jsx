...
import w2 from "../assets/workshop/w2.jpeg";
import w3 from "../assets/workshop/w3.jpeg";
import w4 from "../assets/workshop/w4.jpeg";
import w5 from "../assets/workshop/w5.jpeg";

const images = [w1, w2, w3,  w5];
  ...
  return (
    <section className="w-full bg-[#F8FAFC] py-16 md:py-20">
      ...
      <div className="mb-10 w-full px-5 text-center">
        <h2 className="mx-auto w-full text-center text-4xl font-bold tracking-tight text-[#1E293B] md:text-5xl lg:text-6xl">
          Our Workshop
        </h2>
